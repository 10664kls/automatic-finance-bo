...
import DrawerAddWording from "./DrawerAddWording";
import DrawerEditWording from "./DrawerEditWording";

const TabSalaryWording = () => {
      ...
      <Paper
        ...
        <Stack
          ...
          <Typography variant="h6">
            Wordings used for income from salary
            <Button
...
export default TabSalaryWording;
